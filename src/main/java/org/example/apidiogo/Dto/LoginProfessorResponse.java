...
public class LoginProfessorResponse {
    ...
    @Schema(description = "Usuario do professor autenticado.", example = "Julia")
    private String usuario;

    public LoginProfessorResponse(String token, String usuario) {
        this.token = token;
